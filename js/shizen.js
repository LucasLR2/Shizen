...
function updateStats() {
    ...
    if (statsClipboard) statsClipboard.textContent = appData.clipboard.length;
...
function logout() {
    if (confirm('¿Estás seguro de que quieres cerrar sesión? Asegúrate de haber exportado tus datos.')) {
